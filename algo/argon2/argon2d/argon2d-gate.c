...
void argon2id_aqua_hash( void *output, const void *input )
{
	...
	context.salt = (uint8_t *)NULL; //salt = input
	...
	context.m_cost = 1; // Memory in KiB (~256KB)
                      ...
                      uint64_t *hashes_done )
{
        ...
        do {
                ...
                argon2id_aqua_hash( hash, endiandata );
...
{
        gate->scanhash = (void*)&scanhash_argon2id_aqua;
        gate->hash = (void*)&argon2id_aqua_hash;
